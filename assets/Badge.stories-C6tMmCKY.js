...
@default 'standard'`}}};c.__docgenInfo={description:"The <code>dot</code> prop changes a badge into a small dot. This can be used as a notification that something has changed without giving a count.",methods:[],displayName:"DotBadge",props:{anchorOrigin:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  vertical: "top" | "bottom";
  horizontal: "left" | "right";
}`,signature:{properties:[{key:"vertical",value:{name:"union",raw:'"top" | "bottom"',elements:[{name:"literal",value:'"top"'},{name:"literal",value:'"bottom"'}],required:!0}},{key:"horizontal",value:{name:"union",raw:'"left" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"right"'}],required:!0}}]}},description:`The anchor of the badge.
@default {
...
If 'true' the badge is invisible.
@default false`},variant:{required:!1,tsType:{name:"union",raw:'"dot" | "standard"',elements:[{name:"literal",value:'"dot"'},{name:"literal",value:'"standard"'}]},description:`The variant to use.
@default 'standard'`}}};d.__docgenInfo={description:"Use <code>color</code> prop to apply theme palette to component.",methods:[],displayName:"BadgeColor",props:{anchorOrigin:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  vertical: "top" | "bottom";
  horizontal: "left" | "right";
}`,signature:{properties:[{key:"vertical",value:{name:"union",raw:'"top" | "bottom"',elements:[{name:"literal",value:'"top"'},{name:"literal",value:'"bottom"'}],required:!0}},{key:"horizontal",value:{name:"union",raw:'"left" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"right"'}],required:!0}}]}},description:`The anchor of the badge.
@default {
...
If 'true' the badge is invisible.
@default false`},variant:{required:!1,tsType:{name:"union",raw:'"dot" | "standard"',elements:[{name:"literal",value:'"dot"'},{name:"literal",value:'"standard"'}]},description:`The variant to use.
@default 'standard'`}}};p.__docgenInfo={description:"The visibility of badges can be controlled using the <code>invisible</code> prop.",methods:[],displayName:"BadgeVisibility",props:{anchorOrigin:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  vertical: "top" | "bottom";
  horizontal: "left" | "right";
}`,signature:{properties:[{key:"vertical",value:{name:"union",raw:'"top" | "bottom"',elements:[{name:"literal",value:'"top"'},{name:"literal",value:'"bottom"'}],required:!0}},{key:"horizontal",value:{name:"union",raw:'"left" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"right"'}],required:!0}}]}},description:`The anchor of the badge.
@default {
...
If 'true' the badge is invisible.
@default false`},variant:{required:!1,tsType:{name:"union",raw:'"dot" | "standard"',elements:[{name:"literal",value:'"dot"'},{name:"literal",value:'"standard"'}]},description:`The variant to use.
@default 'standard'`}}};m.__docgenInfo={description:"You can use the <code>anchorOrigin</code> prop to move the badge to any corner of the wrapped element.",methods:[],displayName:"BadgeAlignment",props:{anchorOrigin:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  vertical: "top" | "bottom";
  horizontal: "left" | "right";
}`,signature:{properties:[{key:"vertical",value:{name:"union",raw:'"top" | "bottom"',elements:[{name:"literal",value:'"top"'},{name:"literal",value:'"bottom"'}],required:!0}},{key:"horizontal",value:{name:"union",raw:'"left" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"right"'}],required:!0}}]}},description:`The anchor of the badge.
@default {
...
@default 'standard'`}}};var B,j,w,S,C;s.parameters={...s.parameters,docs:{...(B=s.parameters)==null?void 0:B.docs,source:{originalSource:`(args: BadgeProps) => <Stack justify="center" spacing={2} style={{
  ...
  </Stack>`,...(V=(N=d.parameters)==null?void 0:N.docs)==null?void 0:V.source},description:{story:"Use <code>color</code> prop to apply theme palette to component.",...(_=(M=d.parameters)==null?void 0:M.docs)==null?void 0:_.description}}};var H,E,L,P,A;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`(args: BadgeProps) => {
...
}`,...(L=(E=p.parameters)==null?void 0:E.docs)==null?void 0:L.source},description:{story:"The visibility of badges can be controlled using the <code>invisible</code> prop.",...(A=(P=p.parameters)==null?void 0:P.docs)==null?void 0:A.description}}};var D,U,Y,F,G;m.parameters={...m.parameters,docs:{...(D=m.parameters)==null?void 0:D.docs,source:{originalSource:`(args: BadgeProps) => {
...
}`,...(Y=(U=m.parameters)==null?void 0:U.docs)==null?void 0:Y.source},description:{story:"You can use the <code>anchorOrigin</code> prop to move the badge to any corner of the wrapped element.",...(G=(F=m.parameters)==null?void 0:F.docs)==null?void 0:G.description}}};const le=["BasicBadge","DotBadge","BadgeColor","BadgeVisibility","BadgeAlignment"];export{m as BadgeAlignment,d as BadgeColor,p as BadgeVisibility,s as BasicBadge,c as DotBadge,le as __namedExportsOrder,ie as default};
