...
}`,...(l=(c=t.parameters)==null?void 0:c.docs)==null?void 0:l.source},description:{story:"Basic card example.",...(m=(p=t.parameters)==null?void 0:p.docs)==null?void 0:m.description}}};var h,u,f,g,y;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:`(args: typeof Card) => {
...
}`,...(f=(u=a.parameters)==null?void 0:u.docs)==null?void 0:f.source},description:{story:"For diverse levels of card shadows use the <b>elevation</b> prop.",...(y=(g=a.parameters)==null?void 0:g.docs)==null?void 0:y.description}}};var C,b,v,j,I;s.parameters={...s.parameters,docs:{...(C=s.parameters)==null?void 0:C.docs,source:{originalSource:`(args: typeof Card) => {
  return <Stack spacing={4} justify="center">
      <Card {...args} elevation={0} hasBorder>
        Card With Border
      </Card>
    </Stack>;
}`,...(v=(b=s.parameters)==null?void 0:b.docs)==null?void 0:v.source},description:{story:"For card with border use the <b>hasBorder</b> prop.",...(I=(j=s.parameters)==null?void 0:j.docs)==null?void 0:I.description}}};var w,B,x,k,E;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`(args: typeof Card) => {
  return <Stack spacing={4} justify="center">
      <Card {...args} elevation={0} borderColor="blue">
        Card With Custom Border Color
      </Card>
    </Stack>;
}`,...(x=(B=n.parameters)==null?void 0:B.docs)==null?void 0:x.source},description:{story:"Card with custom border color, use the <b>borderColor</b> prop.",...(E=(k=n.parameters)==null?void 0:k.docs)==null?void 0:E.description}}};const z=["Basic","Elevation","WithBorder","WithCustomBorderColor"];export{t as Basic,a as Elevation,s as WithBorder,n as WithCustomBorderColor,z as __namedExportsOrder,q as default};
