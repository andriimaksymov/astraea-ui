...
import { Button, Input, MenuItem, Radio, Stack, Typography } from "../../index";
...
export const Elevation = (args: MenuProps) => {
  ...
  return (
    <Stack spacing={4} justify="center">
      <Button
        onClick={(e: MouseEvent<HTMLButtonElement>) => handleMenuOpen(e)(1)}
      >
        Elevation 1
      </Button>
      <Button
        onClick={(e: MouseEvent<HTMLButtonElement>) => handleMenuOpen(e)(2)}
      >
        Elevation 2
      </Button>
      <Button
        onClick={(e: MouseEvent<HTMLButtonElement>) => handleMenuOpen(e)(3)}
      >
        Elevation 3
      </Button>
      <Button
        onClick={(e: MouseEvent<HTMLButtonElement>) => handleMenuOpen(e)(4)}
      >
        Elevation 4
      </Button>
      <Menu
...
export const Position = () => {
  ...
  const handleChangeAnchorOrigin = (
    e: ChangeEvent<HTMLInputElement>,
    type: keyof MenuOrigin,
  ) => {
