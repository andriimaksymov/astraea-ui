...
export const Basic = (args: typeof Combobox) => (
  <Stack justify="center">
    <Combobox {...args} placeholder="Select" />
  </Stack>
);

export const SearchInput = (args: typeof Combobox) => {
  const [comboboxItems, setComboboxItems] =
    useState<Array<ComboboxItem>>(top100Films);

  const handleChangeValue = (value: string) => {
    setComboboxItems(
      top100Films.filter((i) => i.value.toString().includes(value)),
    );
  };
